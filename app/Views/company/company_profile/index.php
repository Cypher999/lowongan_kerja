...
<html>
	...
	<body>
			...
			<div class="row table-bordered p-3">
					...
					<div class="col-lg-8">
						...
						<div class="row">
							...
							<a href='<?php echo BASE_URL."?a=company_profile/company_data"?>'><button type="button" class="btn btn-outline-success"><i class="far fa-address-book"></i> Lihat Data Perusahaan</button></a>
						</div>
						<?php } else {?>
						<div class="row">
							<div class="col">
								<a href='<?php echo BASE_URL."?a=Loker"?>'><button type="button" class="btn btn-outline-primary"><i class="far fa-file-alt"></i> Lihat daftar lamaran</button></a>
							</div>
							<div class="col">
								<a href='<?php echo BASE_URL."?a=Company_profile/company_data"?>'><button type="button" class="btn btn-outline-success"><i class="far fa-address-book"></i> Lihat Data Perusahaan</button></a>
							</div>
		...
		<?php } else{echo "<div class='container mb-5 p-2'>anda belum menambah data perusahaan</div>";}?>
