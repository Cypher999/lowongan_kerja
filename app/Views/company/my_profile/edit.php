<!DOCTYPE html>
<html>
	<?php $this->view("company/my_profile/__partials/head");?>
	<body>
				...
				<div class='card-body'>
					...
					<div class="row">
						...
						<div class='row'>
							...
							<div class='col'>
								<input type='text' class="form-control" name='bidang' placeholder="bidang" pattern="[a-zA-Z0-9]{1,}" required="" value="<?php echo $exp[2];?>">
							</div>
							<?php } else{ ?>
		...
		<?php $this->view("company/my_profile/__partials/js");?>
	</body>
</html>
