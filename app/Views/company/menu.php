	...
	<div class="collapse navbar-collapse" id="collapsiblenavbar">
		<ul class="navbar-nav">			
			<li class="nav-item pl-3 pr-3">
				<div class='nav-link'>
					<a class="btn sing-it" href="?a=Company_profile" >User : <?php echo $nm_user;?></a>
				</div>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
				<div class="dropdown nav-link">
					<button class="btn dropdown-toggle" type="button" data-toggle="dropdown">Data perusahaan</button>
					<div class="dropdown-menu">
					<a class='dropdown-item' href="?a=Loker">Lihat Daftar Lamaran</a>
					<a class='dropdown-item' href="?a=Kritik_company/list">Daftar masukkan / kritik</a>
					<a class='dropdown-item'  href='?a=Company_profile/company_data'>Data Perusahaan</a>
					</div>
				</div>
			</li>
			...
			<li class="nav-item">
				<div class="nav-link">
					<a class="btn" href="?a=Customer_care">Customer care</a>
				</div>
			</li>
			<li class="nav-item">
				<div class="nav-link">
