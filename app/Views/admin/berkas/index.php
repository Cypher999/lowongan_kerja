<!DOCTYPE html>
<html>
	<?php $this->view("admin/berkas/__partials/head");?>
	<body>	
	...
	<div class='container mb-5'>
		...
		<div class='card col-lg-12 p-2'>
				<div class='card-header'><h2>Berkas milik <?php echo $data["nama_user"];?></h2></div>
		...
		<?php $this->view("admin/berkas/__partials/js");?>
	</body>
</html>