<!DOCTYPE html>
<html>
	<?php $this->view("applyer/home/__partials/head");?>
	<body>	
	...
	<div class='container mb-5'>
		...
		if($data["cek_lengkap"]=="0"){
			echo "<h2>DATA PROFIL BELUM LENGKAP, SILAHKAN LENGKAPI DI MENU PROFIL</h2>";}
			?>
			<div class='row'>
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 pb-5 pt-5 mt-5 bg-primary text-light" align="middle">
					<h2>Welcome to r@tjob<br> Silahkan pilih lowongan yang menurut anda menarik</h2>
				</div>
				<div class="col-lg-12">
					<div class="row mt-6">
		...
		<?php $this->view("applyer/home/__partials/js");?>
		<script>
				var dt={};
